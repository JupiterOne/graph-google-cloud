...
export async function fetchCloudSslCertification(
  ...
  await jobState.iterateEntities(
    ...
    async (sqlInstanceEntity) => {
      ...
      await client.iterateCloudSslCertification(
        instanceName,
        async (sslCertification) => {
          const cloudSslCertificationEntity =
            createCloudSslCertificationEntity(sslCertification);
...
export async function fetchCloudSqlBackup(
  ...
  await jobState.iterateEntities(
    ...
    async (sqlInstanceEntity) => {
      const instanceName = sqlInstanceEntity.name as string;
      await client.iterateCloudSqlBackup(
        instanceName,
        async (cloudSqlBackup) => {
          const cloudSqlBackupEntity =
            createCloudSqlBackupEntity(cloudSqlBackup);
...
export async function fetchCloudSqlConnection(
  ...
  await jobState.iterateEntities(
    ...
    async (sqlInstanceEntity) => {
      const instanceName = sqlInstanceEntity.name as string;
      await client.iterateCloudSqlConnection(
        instanceName,
        async (cloudSqlConnection) => {
          const cloudSqlConnectionEntity =
            createCloudSqlConnectionEntity(cloudSqlConnection);
...
export async function fetchCloudSqlDatabase(
  ...
  await jobState.iterateEntities(
    ...
    async (sqlInstanceEntity) => {
      const instanceName = sqlInstanceEntity.name as string;
      await client.iterateCloudSqlDatabase(
        instanceName,
        async (cloudSqlDatabase) => {
          const cloudSqlBackupEntity =
            createCloudSqlDatabaseEntity(cloudSqlDatabase);
          await jobState.addEntity(cloudSqlBackupEntity);
        },
      );
    },
...
export const cloudSqlSteps: GoogleCloudIntegrationStep[] = [
  ...
  },
  {
    ...
    ingestionSourceId: IngestionSources.CLOUD_PROJECT_HAS_CLOUD_SQL,
    name: 'Project HAS cloud sql',
    entities: [],
    relationships: [
      {
        _class: RelationshipClass.HAS,
        _type: RELATIONSHIP_TYPE_CLOUD_PROJECT_HAS_CLOUD_SQL,
        sourceType: PROJECT_ENTITY_TYPE,
        targetType: ENTITY_TYPE_CLOUD_SQL,
      },
    ],
    dependsOn: [STEP_RESOURCE_MANAGER_PROJECT, STEP_CLOUD_SQL],
  ...
  },
  {
    ...
    ingestionSourceId: IngestionSources.CLOUD_SQL_HAS_CLOUD_SQL_INSTANCES,
    ...
    dependsOn: [STEP_CLOUD_SQL_INSTANCES, STEP_CLOUD_SQL],
  ...
  },
  {
    ...
    dependsOn: [STEP_CLOUD_SQL_INSTANCES, STEP_CLOUD_SQL_BACKUP],
  ...
  },
  {
    ...
    dependsOn: [STEP_CLOUD_SQL_SSL_CERTIFICATION, STEP_CLOUD_SQL_INSTANCES],
  ...
  },
  {
    ...
    dependsOn: [STEP_CLOUD_SQL_DATABASE, STEP_CLOUD_SQL_INSTANCES],
  ...
  },
  {
    ...
    dependsOn: [STEP_CLOUD_SQL_CONNECTION, STEP_CLOUD_SQL_INSTANCES],
  ...
  },
  {
    ...
    dependsOn: [STEP_CLOUD_USER, STEP_CLOUD_SQL_INSTANCES],
  ...
  },
  {
    ...
    ingestionSourceId: IngestionSources.CLOUD_SQL_HAS_CLOUD_SQL_DATABASE,
    name: 'Cloud Sql Has Sql database',
    entities: [],
    relationships: [
      {
        _class: RelationshipClass.HAS,
        _type: RELATIONSHIP_TYPE_GOOGLE_CLOUD_SQL_HAS_CLOUD_SQL_DATABASE,
        sourceType: ENTITY_TYPE_CLOUD_SQL,
        targetType: ENTITY_TYPE_CLOUD_SQL_DATABASE,
      },
    ],
    dependsOn: [STEP_CLOUD_SQL_DATABASE, STEP_CLOUD_SQL],
