...
export function createCloudSslCertificationEntity(data: sqladmin_v1.Schema$SslCert) {
  return createIntegrationEntity({
    entityData: {
      source: data,
      assign: {
...
export function createCloudSqlConnectionEntity(data: sqladmin_v1.Schema$ConnectSettings) {
  // Function to extract IP addresses from ipAddresses array
  function extractIPAddresses(ipAddresses: sqladmin_v1.Schema$IpMapping[] | undefined): string | undefined {
...
export function createCloudSqlDatabaseEntity(data: sqladmin_v1.Schema$Database) {
  return createIntegrationEntity({
    entityData: {
      source: data,
      assign: {
