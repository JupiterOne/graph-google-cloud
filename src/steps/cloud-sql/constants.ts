...
export const RELATIONSHIP_TYPE_CLOUD_PROJECT_HAS_CLOUD_SQL =
  'google_cloud_project_has_sql'; // done 
...
export const RELATIONSHIP_TYPE_CLOUD_SQL_HAS_CLOUD_SQL_INSTANCES =
  'google_cloud_sql_has_sql_instance';// done 
...
export const STEP_CLOUD_SQL_INSTANCES_USES_CLOUD_SQL_SSL_CERTIFICATION =
  'fetch-cloud-sql-instances-has-sql-ssl-certification';
...
export const STEP_CLOUD_SQL_INSTANCES_USES_CLOUD_SQL_DATABASE =
  'fetch-cloud-sql-instances-has-sql-database';
export const RELATIONSHIP_TYPE_CLOUD_SQL_INSTANCES_USES_CLOUD_SQL_DATABASE =
  'google_cloud_sql_instance_has_sql_database';
...
export const RELATIONSHIP_TYPE_CLOUD_SQL_INSTANCES_ASSIGNED_GOOGLE_USER =
  'google_cloud_sql_instance_assigned_google_user';
...
export const IngestionSources = {
  ...
  CLOUD_SQL_SSL_CERTIFICATION_HAS_CLOUD_SQL_BACKUP: 'cloud-sql-ssl-certification-has-sql-backup',
  CLOUD_SQL_INSTANCES_HAS_CLOUD_SQL_BACKUP: 'cloud-sql-instances-has-sql-backup',
  CLOUD_SQL_INSTANCES_USES_CLOUD_SQL_SSL_CERTIFICATION: 'cloud-sql-instances-has-sql-ssl-certification',
  CLOUD_SQL_INSTANCES_HAS_CLOUD_SQL_CONNECTION: 'cloud-sql-instances-has-sql-connection',
  CLOUD_SQL_INSTANCES_USES_CLOUD_SQL_DATABASE: 'cloud-sql-instances-has-sql-database',
  CLOUD_SQL_INSTANCES_ASSIGNED_GOOGLE_USER: 'cloud-sql-instances-assigned-google-user',
