...
import { ExplicitRelationship, Relationship } from '@jupiterone/integration-sdk-core';
import { buildProjectHasSqlRelationship, buildSqlHasSqlInstancesRelationship, fetchCloudSql, fetchCloudSqlInstances } from '.';
import { fetchResourceManagerProject, PROJECT_ENTITY_TYPE } from '../resource-manager';
