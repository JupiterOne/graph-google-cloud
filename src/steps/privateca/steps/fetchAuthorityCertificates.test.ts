...
describe(`privateca#${PrivatecaSteps.STEP_PRIVATE_CA_CERTIFICATES.id}`, () => {
  ...
  test(PrivatecaSteps.STEP_PRIVATE_CA_CERTIFICATES.id, async () => {
    recording = setupGoogleCloudRecording({
      name: PrivatecaSteps.STEP_PRIVATE_CA_CERTIFICATES.id,
      directory: __dirname,
      options: {
    ...
    const stepTestConfig: StepTestConfig = {
      stepId: PrivatecaSteps.STEP_PRIVATE_CA_CERTIFICATES.id,
