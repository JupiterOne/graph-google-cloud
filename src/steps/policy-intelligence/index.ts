...
export async function fetchPolicyAnalyzer(
    ...
    await jobState.iterateEntities(
        ...
        async (policyAnalyzerActivity) => {
            const policyAnalyzerEntity = createPolicyIntelligenceAnalyzerEntity(policyAnalyzerActivity, client.projectId);
...
export async function buildPolicyAnalyzerHasPolicyAnalyzerActivityRelationship(
    ...
    await jobState.iterateEntities(
        { _type: POLICY_INTELLIGENCE_ANALYZER_ACTIVITY_TYPE },
        async (policyAnalyzerActivity) => {
            const policyAnalyzerKey = policyAnalyzerActivity.serviceAccountId as string
...
export const PolicyAnalyzerSteps: GoogleCloudIntegrationStep[] = [
    ...
    },
    {
        ...
        relationships: [
            {
                _class: RelationshipClass.HAS,
                _type: RELATIONSHIP_TYPE_GOOGLE_CLOUD_PROJECT_HAS_POLICY_INTELLIGENCE_ANALYZER_ACTIVITY,
    ...
    },
    {
        ...
        relationships: [
            {
                _class: RelationshipClass.HAS,
                _type: RELATIONSHIP_TYPE_GOOGLE_CLOUD_PROJECT_HAS_POLICY_INTELLIGENCE_ANALYZER,
                sourceType: PROJECT_ENTITY_TYPE,
    ...
    },
    {
        ...
        relationships: [
            {
                _class: RelationshipClass.HAS,
                _type: RELATIONSHIP_TYPE_POLICY_INTELLIGENCE_ANALYZER_HAS_POLICY_INTELLIGENCE_ANALYZER_ACTIVITY,
