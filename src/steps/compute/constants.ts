// Steps
export const STEP_COMPUTE_ENGINE_AUTOSCALERS =
  'fetch-compute-engine-autoscalers';
export const STEP_COMPUTE_ENGINE_REGION_AUTOSCALERS =
  'fetch-compute-engine-region-autoscalers';
...
export const ENTITY_TYPE_COMPUTE_ENGINE_AUTOSCALER =
  'google_cloud_compute_autoscaler';

export const ENTITY_CLASS_COMPUTE_ENGINE_REGION_AUTOSCALERS = ['Configuration'];
export const ENTITY_TYPE_COMPUTE_ENGINE_REGION_AUTOSCALER =
  'google_cloud_compute_region_autoscaler';
...
export const ENTITY_TYPE_AUTOSCALER_REGION_POLICY =
  'google_cloud_region_autoscaler_policy';
