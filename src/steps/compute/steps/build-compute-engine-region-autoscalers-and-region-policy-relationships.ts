...
export const buildComputeEngineRegionAutoscalerRegionPolicyRelationshipStepMap: GoogleCloudIntegrationStep =
{
    ...
    dependsOn: [STEP_COMPUTE_ENGINE_REGION_AUTOSCALERS, STEP_AUTOSCALER_REGION_POLICY],
    executionHandler: buildComputeEngineRegionAutoscalerRegionPolicyRelationship,
};