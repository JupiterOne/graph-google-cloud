...
export const NETWORK_ANALYZER_CONNECTIVITY_TEST_TYPE = 'google_cloud_network_analyzer_connectivity_test';
export const STEP_NETWORK_ANALYZER_CONNECTIVITY_TEST = 'fetch-network-analyzer-connectivity-test';
...
export const VPN_GATEWAY_TUNNEL_TYPE = 'google_cloud_vpn_gateway_tunnel';
...
export const IngestionSources = {
  ...
  PROJECT_HAS_NETWORK_INTELLIGENCE_CENTER_RELATIONSHIP: 'project-has-network-intelligence-center-relation',
  NETWORK_ANALYZER_CONNECTIVITY_TEST: 'network-analyzer-connectivity-test',
  NETWORK_ANALYZER_CONNECTIVITY_TEST_USES_NETWORK_ANALYZER_VPC_RELATIONSHIP: 'network-analyzer-connectivity-test-relation-uses-network-analyzer-vpc-relation',
  PROJECT_HAS_NETWORK_ANALYZER_CONNECTIVITY_TEST_RELATIONSHIP: 'project-has-network-analyzer-connectivity-test-relation',
  NETWORK_INTELLIGENCE_CENTER_HAS_NETWORK_ANALYZER_CONNECTIVITY_TEST_RELATIONSHIP: 'network-intelligence-center-hasnetwork-analyzer-connectivity-test-relation',
  VPN_GATEWAY_TUNNEL: 'vpn-gateway-tunnel',
  NETWORK_ANALYZER_VPC: 'network-analyzer-vpc',
  PROJECT_USES_NETWORK_ANALYZER_VPC_RELATIONSHIP: 'project-uses-network-analyzer-vpc-relation',
  NETWORK_ANALYZER_VPC_USES_VPN_GATEWAY_RELATIONSHIP: 'network-analyzer-vpc-uses-vpn-gateway-relation',
  VPN_GATEWAY: 'vpn-gateway',
  VPN_GATEWAY_USES_VPN_GATEWAY_TUNNEL_RELATIONSHIP: 'vpn-gateway-uses-vpn-gateway-tunnel'
};
