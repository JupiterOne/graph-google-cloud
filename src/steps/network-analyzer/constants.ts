...
export const STEP_CONNECTIVITY_TEST_SCANS_APP_ENGINE_VERSION =
  'build-connectivity-test-scans-app-engine-version-relationship';
export const STEP_CONNECTIVITY_TEST_SCANS_NETWORK =
  'build-connectivity-test-scans-network-relationship';

// Entities Types and Classes
